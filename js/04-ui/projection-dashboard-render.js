...
(function (root) {
  ...
  function _buildTable(years) {
    var head = '<tr><th>Year</th><th>Tax Without</th><th>Tax With</th><th>Savings</th>' +
               '<th>Investment</th><th>Loss Generated</th><th>Fee</th></tr>';
    var body = '';
    ...
    body += '<tr class="rett-total-row">' +
      ...
      '<td>' + _fmt(cNo) + '</td>' +
      '<td>' + _fmt(cWith) + '</td>' +
      '<td class="rett-savings-cell">' + _fmt(cSave) + '</td>' +
      '<td>' + _fmt(cInv) + '</td>' +
      '<td>' + _fmt(cLoss) + '</td>' +
      '<td>' + _fmt(cFee) + '</td>' +
    '</tr>';
    return '<div class="rett-table-wrap">' +
      '<table class="rett-data-table"><thead>' + head + '</thead><tbody>' + body + '</tbody></table>' +
      '</div>';
  }
