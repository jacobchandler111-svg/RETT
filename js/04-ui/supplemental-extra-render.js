  ...
  var SPECS = [
    {
      ...
      descriptor: 'A pass-through entity pays state income tax at the entity level, bypassing the federal SALT cap.',
    ...
    // ----------------------------------------------------------------
    {
      ...
      descriptor: 'An engineering study reclassifies building components into 5/15-year buckets and front-loads depreciation with 100% bonus.',
    ...
    },
    {
      ...
      descriptor: 'Rent your home to your business up to 14 days a year &mdash; deductible to the entity, tax-free to you under §280A(g).',
    ...
    },
    {
      ...
      descriptor: 'Maximize owner deferral plus a 25% employer profit-share, up to a $72,000 annual addition cap.',
      audience: 'Business owner',
      bucket: 'ordinary',
      defaults: {
        compensation:  300000,
